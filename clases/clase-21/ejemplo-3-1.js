...
console.info('Ancho del body:', ancho);

// 4. Con el evento onresize del body, actualizar el ancho (mostrarlo por consola):
d.body.onresize = function() {
	ancho = d.body.offsetWidth;
	console.info('Ancho del body onresize:', ancho);
}

// 5. Obtener el ancho del div (mostrarlo por consola):
let anchoDiv = div.offsetWidth;
console.info('Ancho del div:', anchoDiv);
